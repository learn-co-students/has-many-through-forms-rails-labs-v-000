...
#
#
# comment_1 = Comment.create({content: "good job", user_id: 3, post_id: 3 })
# comment_2= Comment.create({content: "love it", user_id: 2, post_id: 3  })
# comment_3= Comment.create({content: "Your posts are always so interesting.", user_id: 1, post_id: 2 })
# comment_4 = Comment.create({content: "You write so well", user_id: 5, post_id: 1 })
# comment_5 = Comment.create({content: "What an interesting take on Maggie Simpson", user_id: 5, post_id: 4 })
#
